...
All flags are available on the command line as well as [Gradle](https://kotlinlang.org/docs/reference/using-gradle.html#compiler-options) and [Maven](https://kotlinlang.org/docs/reference/using-maven.html#specifying-compiler-options).
