...
Only features and components published as [Fully Stable](/docs/reference/components-stability.html#fully-stable) are in the scope of Language Committee. Besides, the Language Committee's scope is limited to the following:
...
For example, the following matter are out of scope for the Language Committee:
